...
@patch('json.dump')
@patch('json.loads')
def test_log_reports_default_filename(mock_json_loads, mock_json_dump, mock_file_open, mock_datetime):
...
@patch('json.dump')
@patch('json.loads')
def test_log_reports_custom_filename(mock_json_loads, mock_json_dump, mock_file_open):
...
@patch('builtins.open', new_callable=mock_open)
@patch('json.dump')
def test_log_reports_write_exception(mock_json_dump, mock_file_open):
...
@patch('builtins.open', new_callable=mock_open)
def test_log_reports_no_to_json_method(mock_file_open):
...
@patch('src.reports.datetime')
@patch('builtins.open', new_callable=mock_open)
def test_log_reports_creates_directory(mock_file_open, mock_datetime):
...
def test_log_reports_preserves_arguments():
